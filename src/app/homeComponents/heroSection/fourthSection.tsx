  ...
  return (
    <div className="flex justify-center gap-[8rem] items-center px-[3rem]">
      <div className="max-w-[40rem] my-[4rem]">
        <div className="text-right tabletGallery:text-left">
          <h2 className="text-[1.5rem] max400:text-[1.3rem] font-bold text-[#de2426]">
            Why CENTURY SCHOOL ?
          </h2>
        </div>
        <p className="text-justify text-[17px] max400:text-[15px] mb-[2rem] mt-[1rem]">
      ...
      <div className="h-[31.2rem] w-[18.7rem] relative mt-[-1.5rem] z-[50] mb-[-1.5rem] shadow-[0px_-2.5px_9px_10px_rgba(0,0,0,0.4)] tabletGallery:hidden">
        <Image
          alt="Photo2"
          src={image2}
          placeholder="blur"
